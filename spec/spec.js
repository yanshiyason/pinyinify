...
describe("Pinyinify", () => {
    ...
    it("selects the correct pronunciation for 多音字", () => {
        ...
        expect("我觉得睡觉是很重要的。我睡了一个好觉有很好的感觉。").becomes("wǒ juéde shuìjiào shì hěn zhòngyào de. wǒ shuì le yī gè hǎo jiào yǒu hěn hǎo de gǎnjué.");
        expect("你看她干吗？她是你的女朋友吗？").becomes("nǐ kàn tā gànmá? tā shì nǐ de nǚpéngyou ma?");
        expect("他给我发了个短信：“我长大的时候我的头发很长。但是现在我喜欢理发。”").becomes("tā gěi wǒ fā le gè duǎnxìn: ``wǒ zhǎngdà de shíhou wǒ de tóufa hěn cháng. dànshì xiànzài wǒ xǐhuan lǐfà.\"");
    ...
    it("doesn't mangle numbers or non-Chinese text", () =>{
        expect("我有2个。他有540！50%的意思是百分之五十。").becomes("wǒ yǒu 2 gè. tā yǒu 540! 50% de yìsi shì bǎifēnzhī wǔshí.");
